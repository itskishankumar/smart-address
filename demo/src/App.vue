  ...
  <div class="page">
    ...
    <footer class="footer">
      <div class="footer-links">
        <a
          href="https://github.com/itskishankumar/smart-address"
          target="_blank"
          rel="noopener"
          aria-label="GitHub"
        >
          ...
          >
            <path
              d="M12 .5C5.65.5.5 5.65.5 12a11.5 11.5 0 0 0 7.86 10.92c.57.1.78-.25.78-.55 0-.27-.01-1-.02-1.96-3.2.7-3.87-1.54-3.87-1.54-.52-1.33-1.28-1.68-1.28-1.68-1.05-.72.08-.7.08-.7 1.16.08 1.77 1.2 1.77 1.2 1.03 1.76 2.7 1.25 3.36.96.1-.75.4-1.26.73-1.55-2.55-.29-5.23-1.28-5.23-5.68 0-1.26.45-2.28 1.19-3.09-.12-.29-.52-1.46.11-3.04 0 0 .97-.31 3.18 1.18a11.1 11.1 0 0 1 5.79 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.58.23 2.75.11 3.04.74.81 1.18 1.83 1.18 3.09 0 4.41-2.69 5.39-5.25 5.67.41.36.77 1.06.77 2.13 0 1.54-.01 2.78-.01 3.16 0 .3.2.66.79.55A11.5 11.5 0 0 0 23.5 12C23.5 5.65 18.35.5 12 .5z"
            />
          </svg>
        </a>
        <span class="footer-sep">·</span>
        <a
          href="https://www.npmjs.com/package/smart-address"
          target="_blank"
          rel="noopener"
          aria-label="npm"
        >
      ...
      <div class="footer-made">
        Made by
        <a href="https://itskishankumar.com" target="_blank" rel="noopener"
          >itskishankumar.com</a
        >
      </div>
    </footer>
  </div>
